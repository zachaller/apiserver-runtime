...
# 3. rewrite the history on that branch to *only* include staging/src/github.com/zachaller/apiserver-runtime/internal/sample-apiserver
...
# this command rewrite git history to *only* include staging/src/github.com/zachaller/apiserver-runtime/internal/sample-apiserver
git filter-branch -f --subdirectory-filter staging/src/github.com/zachaller/apiserver-runtime/internal/sample-apiserver HEAD
